...
CREATE TABLE IF NOT EXISTS "claimed_city" ( -- SAVES : city 0N:0N game
  "id" integer GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
  "game_id" integer NOT NULL, -- many to many
  "city_id" integer NOT NULL, -- many to many
  "player_id" integer NOT NULL,-- link to player table : OWNS : city/game 11:0N player
  "created_at" timestamptz NOT NULL DEFAULT CURRENT_TIMESTAMP,
  "updated_at" timestamptz
);

CREATE TABLE IF NOT EXISTS "claimed_route"( -- SAVES : route 0N:0N game
  "id" integer GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
  "game_id" integer NOT NULL, -- many to many
  "route_id" integer NOT NULL, -- many to many
  "player_id" integer NOT NULL,-- link to player table : OWNS : route/game 11:0N player
  "created_at" timestamptz NOT NULL DEFAULT CURRENT_TIMESTAMP,
  "updated_at" timestamptz
);

CREATE TABLE IF NOT EXISTS "attempted_mission"( -- SAVES : mission 0N:0N game
  "id" integer GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
  "completed" boolean NOT NULL DEFAULT FALSE,
  "game_id" integer NOT NULL, -- many to many
  "mission_id" integer NOT NULL, -- many to many
  "player_id" integer NOT NULL,-- link to player table : TRIES : mission/game 11:0N player
  "created_at" timestamptz NOT NULL DEFAULT CURRENT_TIMESTAMP,
  "updated_at" timestamptz
);
...
CREATE TABLE IF NOT EXISTS "deck" ( -- each deck line belongs to a single game
  ...
  "game_id" integer NOT NULL, -- SAVES : deck 11:0N game
  "created_at" timestamptz NOT NULL DEFAULT CURRENT_TIMESTAMP,
  "updated_at" timestamptz
);
...
--   "id" integer GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
--   "game_id" integer NOT NULL, -- many to many
--   "deck_id" integer NOT NULL, -- many to many
--   "created_at" timestamptz NOT NULL DEFAULT CURRENT_TIMESTAMP,
--   "updated_at" timestamptz
-- );
...
CREATE TABLE IF NOT EXISTS "game" ( -- one line per game
  "id" integer GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
  "name" text NOT NULL,
  "user_id" integer NOT NULL, -- link to user table : HOSTS : game 11:0N user
...
CREATE TABLE IF NOT EXISTS "mission" (
  ...
  "start_city" integer NOT NULL, -- link to city table : STARTS, 11 mission, 0N city
  "end_city" integer NOT NULL, -- link to city table : ENDS, 11 mission, 0N city
  "created_at" timestamptz NOT NULL DEFAULT CURRENT_TIMESTAMP,
  "updated_at" timestamptz
);
...
CREATE TABLE IF NOT EXISTS "route" (
  ...
  "start_city" integer NOT NULL, -- link to city table : STARTS, 11 route, 0N city
  "end_city" integer NOT NULL, -- link to city table : ENDS, 11 route, 0N city
  "created_at" timestamptz NOT NULL DEFAULT CURRENT_TIMESTAMP,
  "updated_at" timestamptz
);
...
ALTER TABLE "mission" ADD FOREIGN KEY ("start_city") REFERENCES "city" ("id"); -- mission STARTS city
ALTER TABLE "mission" ADD FOREIGN KEY ("end_city") REFERENCES "city" ("id"); -- mission ENDS city
...
ALTER TABLE "route" ADD FOREIGN KEY ("start_city") REFERENCES "city" ("id"); -- route STARTS city
ALTER TABLE "route" ADD FOREIGN KEY ("end_city") REFERENCES "city" ("id"); -- route ENDS city
...
ALTER TABLE "attempted_mission" ADD FOREIGN KEY ("game_id") REFERENCES "game" ("id"); -- game SAVES mission
ALTER TABLE "attempted_mission" ADD FOREIGN KEY ("mission_id") REFERENCES "mission" ("id"); -- game SAVES mission
ALTER TABLE "attempted_mission" ADD FOREIGN KEY ("player_id") REFERENCES "player" ("id"); -- player TRIES mission
